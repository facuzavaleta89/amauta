...
const securityHeaders = [
  ...
  // Restringe acceso a APIs sensibles del browser
  {
    key: 'Permissions-Policy',
    value: 'camera=(), microphone=(), geolocation=(), interest-cohort=()',
  },
  // Content Security Policy — ajustar según proveedores externos que uses
  {
    ...
    value: [
      ...
      // Scripts propios + React inline scripts que Next.js necesita
